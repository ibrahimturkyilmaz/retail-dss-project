...
export default function LoginScreen({ onLogin }) {
    ...
    const handleEmailLogin = async (e) => {
        ...
        try {
            // NOTE: This currently uses the custom backend for "Demo" login without password.
            // To fully sync with Supabase, this should be replaced with Supabase auth (requires adding password field).

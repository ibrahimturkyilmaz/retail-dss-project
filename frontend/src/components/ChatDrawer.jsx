...
const ChatDrawer = () => {
    ...
    // Debugging: Auth durumu
    console.log("ChatDrawer Auth Status:", { user: user?.email, isOpen });

    // if (!user) return null; // GEÇİCİ OLARAK KAPATILDI: Hata ayıklama için her zaman render et
